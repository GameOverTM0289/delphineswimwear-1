 ...
 * shoot. Some products are missing certain colors:
 *   - product-1 (Bikini 1) is missing a "red front" → no Red option.
 * All five products have full Blue + Yellow + (where present) Red.
 *
...
export const STATIC_PRODUCTS: Product[] = [
  // ─── Bikini 1 ────────────────────────────────────────────────────
  // Available in Blue + Yellow. Red shot is back-only — omitted.
  {
    id: 'static-bikini-1',
    slug: 'bikini-1',
    name: 'Bikini 1',
